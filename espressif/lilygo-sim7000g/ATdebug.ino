...
// Function to detect the correct rate for communication with modem
{
...
void setup()
{
    ...
    if (reply) {
        Serial.println(F("***********************************************************"));
        Serial.println(F(" You can now send AT commands, If it doesn't work, select \"Both NL & CR\" in Serial Monitor"));
    } else {
        Serial.println(F("***********************************************************"));
